...
% Eslabón 1:
  theta1=q1; d1=0; a1=0; alpha1=PI/2;
% Eslabón 2:
  theta2=q2-PI/2; d2=-L1; a2=-L2B; alpha2=-PI/2;
% Eslabón 3:
  theta3=0; d3=q3+L2A+L3; a3=0; alpha3=0;
...
% Eslabón 1
  m1= 32.7982; % kg
  s11 = [0 ,0  ,-0.25 ]'; % m
  I11=[0.683295833  , 0 , 0 ; 0, 0.683295833 ,0 ; 0, 0, 0.26894524 ]; % kg.m2

% Eslabón 2
  m2= 131.193; % kg
  s22 = [ 0.75, 0 , 0.75]'; % m
  I22=[ 14.2038288, 0 , 8.1995625 ; 0, 27.331875 , 0;8.1995625 ,0 , 14.2038288]; % kg.m2

% Eslabón 3
  m3= 32.7982; % kg
  s33 = [ 0, 0 , -0.25]'; % m
  I33=[ 0.683295833, 0 , 0 ; 0, 0.683295833 , 0;0 ,0 , 0.26894524]; % kg.m2


% DATOS DE LOS MOTORES
% Inercias
  Jm1= 0.00293177; Jm2=0.00241362; Jm3= 0.00354901; % kg.m2
% Coeficientes de fricción viscosa
  Bm1= 0.000210876; Bm2=0.000115336 ; Bm3=0.000122327  ; % N.m / (rad/s)
% Factores de reducción
  R1= 20.0 ; R2=30.0 ; R3=20.0 ;
